...
export interface ApiActivityActivity extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Required;
    type: Schema.Attribute.Enumeration<['post_like', 'follow']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiAppMediaOwnerAppMediaOwner
  extends Struct.CollectionTypeSchema {
  collectionName: 'app_media_owners';
  info: {
    displayName: 'App Media Owner';
    pluralName: 'app-media-owners';
    singularName: 'app-media-owner';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    appReference: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::app-media-owner.app-media-owner'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    purpose: Schema.Attribute.Enumeration<['post', 'avatar']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    uploadFile: Schema.Attribute.Relation<'oneToOne', 'plugin::upload.file'> &
      Schema.Attribute.Required;
    usageStatus: Schema.Attribute.Enumeration<
      ['uploaded', 'attached', 'unused']
    > &
      Schema.Attribute.Required &
...
export interface ApiAppMediaAppMedia extends Struct.SingleTypeSchema {
  collectionName: 'app_medias';
  info: {
    displayName: 'App Media';
    pluralName: 'app-medias';
    singularName: 'app-media';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiFeedFeed extends Struct.SingleTypeSchema {
...
export interface ApiFollowFollow extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    status: Schema.Attribute.Enumeration<['accepted', 'requested']> &
      Schema.Attribute.Required &
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::post.post'> &
      Schema.Attribute.Private;
    mediaItems: Schema.Attribute.Component<'post.media-item', true> &
      Schema.Attribute.Required &
      ...
      >;
    publishedAt: Schema.Attribute.DateTime;
    status: Schema.Attribute.Enumeration<['published', 'deleted', 'hidden']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'published'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    visibility: Schema.Attribute.Enumeration<['public', 'followers']> &
      Schema.Attribute.Required &
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    postsCount: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<0>;
    profileCompleted: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    ...
    role: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    status: Schema.Attribute.Enumeration<['active', 'suspended', 'deleted']> &
      Schema.Attribute.Required &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::app-media-owner.app-media-owner': ApiAppMediaOwnerAppMediaOwner;
      'api::app-media.app-media': ApiAppMediaAppMedia;
